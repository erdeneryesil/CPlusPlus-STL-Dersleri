...
int main(){
	...
	auto itr=set_symmetric_difference(v1.begin(),v1.end(),v2.begin(),v2.end(),v3.begin());
	//2,3,22,33,0,0,0,0
	...
	itr=set_symmetric_difference(v2.begin(),v2.end(),v1.begin(),v1.end(),v4.begin(),buyukMu);
	//33,22,3,2,0,0,0,0
	...
	//#include<execution>
	//itr=set_symmetric_difference(execution::par,v1.begin(),v1.end(),v2.begin(),v2.end(),v3.begin());
