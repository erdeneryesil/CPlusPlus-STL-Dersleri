...
int main(){
	...
	auto itr=set_union(v1.begin(),v1.end(),v2.begin(),v2.end(),v3.begin());
	//1,2,3,11,22,33,0,0
	...
	itr=set_union(v1.begin(),v1.end(),v2.begin(),v2.end(),v4.begin(),buyukMu);
	//33,22,11,3,2,1,0,0
	...
	//#include<execution>
	//itr=set_union(execution::par,v1.begin(),v1.end(),v2.begin(),v2.end(),v3.begin());
